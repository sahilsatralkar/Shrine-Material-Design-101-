  ...
  override func viewDidLoad() {
    ...
    //TODO: Setup button constraints
      ...
      constraints.append(NSLayoutConstraint(item: cancelButton,
                                            ...
                                            multiplier: 1,
                                            constant: 0))
      constraints.append(contentsOf: NSLayoutConstraint.constraints(withVisualFormat: "H:[cancel]-[next]-|",
    ...
    func textFieldShouldReturn(_ textField: UITextField) -> Bool {
        ...
        if(textField == passwordTextField) {
            ...
            if textFieldCharacterCount < 8 {
                passwordTextFieldController.setErrorText("Password is too short", errorAccessibilityValue: nil)
